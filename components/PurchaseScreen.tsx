...
const styles = StyleSheet.create({
  content: { alignSelf: 'center', gap: 16, maxWidth: 1272, padding: 16, width: '100%' }, title: { color: '#12355B', fontSize: 24, fontWeight: '700' }, description: { color: '#536B83', fontSize: 14, lineHeight: 21, marginBottom: 18, marginTop: 6 }, listHeading: { alignItems: 'flex-start', flexDirection: 'row', flexWrap: 'wrap', gap: 12, justifyContent: 'space-between' }, listCopy: { flexGrow: 1 }, importBox: { alignItems: 'center', backgroundColor: '#F6FAFF', borderColor: '#C9DDF0', borderRadius: 10, borderWidth: 1, flexDirection: 'row', flexWrap: 'wrap', gap: 16, justifyContent: 'space-between', padding: 16 }, importCopy: { flexGrow: 1 }, importTitle: { color: '#12355B', fontSize: 16, fontWeight: '700' }, importText: { color: '#536B83', fontSize: 14, marginTop: 4 }, integrationHint: { color: '#536B83', fontSize: 12, marginTop: 10 }, emptyPurchase: { alignItems: 'center', borderColor: '#D5E4F3', borderWidth: 1, justifyContent: 'center', minHeight: 90, padding: 16 }, emptyText: { color: '#536B83', fontSize: 14, textAlign: 'center' }, purchaseCard: { borderColor: '#D5E4F3', borderRadius: 10, borderWidth: 1, marginTop: 14, overflow: 'hidden', padding: 16 }, purchaseHeading: { alignItems: 'flex-start', flexDirection: 'row', gap: 12, justifyContent: 'space-between' }, invoiceName: { color: '#12355B', fontSize: 18, fontWeight: '800' }, supplierName: { color: '#536B83', fontSize: 14, marginTop: 3 }, statusBadge: { borderRadius: 14, fontSize: 12, fontWeight: '800', overflow: 'hidden', paddingHorizontal: 10, paddingVertical: 5 }, pending: { backgroundColor: '#FFF3D4', color: '#895C05' }, imported: { backgroundColor: '#D6F3F0', color: '#087A73' }, error: { backgroundColor: '#FDE4E0', color: '#A92D24' }, infoGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginTop: 16 }, info: { flexBasis: 145, flexGrow: 1 }, infoLabel: { color: '#536B83', fontSize: 12 }, infoValue: { color: '#162B45', fontSize: 14, fontWeight: '600', marginTop: 3 }, infoEmphasis: { color: '#12355B', fontSize: 16, fontWeight: '800' }, table: { borderColor: '#D5E4F3', borderWidth: 1, marginTop: 14, width: '100%' }, tableScroll: { flexGrow: 1, minWidth: '100%' }, tableContent: { minWidth: 884, width: '100%' }, row: { flexDirection: 'row', minHeight: 46, width: '100%' }, tableHeader: { backgroundColor: '#1677D2', minHeight: 36 }, cell: { borderRightColor: '#D5E4F3', borderRightWidth: 1, color: '#162B45', flex: 1, fontSize: 13, minWidth: 92, paddingHorizontal: 9, paddingTop: 12 }, descriptionCell: { minWidth: 240 }, headerCell: { color: '#FFFFFF', fontWeight: '700', paddingTop: 9 }, totalsRow: { backgroundColor: '#F6FAFF', flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginTop: 14, padding: 12 },
});
