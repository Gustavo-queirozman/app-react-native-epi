...
const styles = StyleSheet.create({
  content: { alignSelf: 'center', padding: 16, width: '100%' }, title: { color: '#075A35', fontSize: 24, fontWeight: '700', marginBottom: 20 }, formGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 14 }, topField: { flexBasis: 280 }, epiPanel: { backgroundColor: '#EEF6F1', borderColor: '#D5E0D9', borderRadius: 9, borderWidth: 1, marginTop: 15, padding: 14 }, panelTitle: { color: '#075A35', fontSize: 18, fontWeight: '700' }, help: { color: '#62746A', fontSize: 12, lineHeight: 18, marginTop: 10, marginBottom: 18 }, daysField: { flexBasis: 180 }, addAction: { alignSelf: 'flex-start', marginTop: 13 }, emptyText: { color: '#62746A', fontSize: 12, marginTop: 13 }, epiList: { gap: 7, marginTop: 13 }, epiItem: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#D5E0D9', borderRadius: 6, borderWidth: 1, flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, paddingVertical: 9 }, epiText: { color: '#23362B', flex: 1, fontSize: 13, paddingRight: 12 }, removeText: { color: '#C64032', fontSize: 13, fontWeight: '700' }, submitAction: { alignSelf: 'flex-start', marginTop: 13 }, cancelAction: { alignSelf: 'flex-start', marginTop: 8 }, table: { borderColor: '#D5E0D9', borderWidth: 1, marginTop: 14 }, row: { flexDirection: 'row', minHeight: 48 }, tableHeader: { backgroundColor: '#14653B', minHeight: 36 }, cell: { borderRightColor: '#D5E0D9', borderRightWidth: 1, color: '#23362B', fontSize: 13, minWidth: 220, paddingHorizontal: 9, paddingTop: 13 }, epiCell: { minWidth: 310 }, headerCell: { color: '#FFFFFF', fontWeight: '700', paddingTop: 10 }, actionCell: { alignItems: 'center', borderRightColor: '#D5E0D9', borderRightWidth: 1, flexDirection: 'row', gap: 6, justifyContent: 'center', minWidth: 170, paddingHorizontal: 8 },
});
