...
const styles = StyleSheet.create({
  ...
  topBar: { marginBottom: 14 }, backButton: { alignSelf: 'flex-start', paddingVertical: 5 }, backText: { color: '#075A35', fontSize: 15, fontWeight: '700' },
  intro: { alignItems: 'center', flexDirection: 'row', gap: 13, marginBottom: 20 }, avatar: { alignItems: 'center', backgroundColor: '#14653B', borderRadius: 28, height: 56, justifyContent: 'center', width: 56 }, avatarText: { color: '#FFFFFF', fontSize: 24, fontWeight: '800' }, title: { color: '#064F2E', fontSize: 26, fontWeight: '700' }, subtitle: { color: '#53645B', fontSize: 14, marginTop: 3 },
  card: { marginBottom: 14 }, sectionTitle: { color: '#075A35', fontSize: 19, fontWeight: '700' }, sectionDescription: { color: '#62746A', fontSize: 14, lineHeight: 20, marginTop: 5 }, formGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 14, marginTop: 20 }, nameField: { flexBasis: 300 }, emailField: { flexBasis: 360 }, phoneField: { flexBasis: 220 }, passwordField: { flexBasis: 260, flexGrow: 1, gap: 7 }, fieldLabel: { color: '#075A35', fontSize: 14, fontWeight: '700' }, passwordInput: { alignItems: 'center', backgroundColor: '#FFFFFF', borderColor: '#AABCB2', borderRadius: 7, borderWidth: 1, flexDirection: 'row', height: 43, paddingRight: 12 }, passwordTextInput: { color: '#17251D', flex: 1, fontSize: 16, height: '100%', paddingHorizontal: 12 }, visibilityText: { color: '#075A35', fontSize: 13, fontWeight: '700' },
