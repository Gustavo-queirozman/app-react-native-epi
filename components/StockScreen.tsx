...
const styles = StyleSheet.create({
  content: { alignSelf: 'center', maxWidth: 1272, padding: 16, width: '100%' }, compactContent: { padding: 12 }, formsRow: { alignItems: 'flex-start', flexDirection: 'row', gap: 12 }, formsColumn: { flexDirection: 'column' }, formCard: { flex: 1, minWidth: 0, padding: 16 }, stackedFormCard: { alignSelf: 'stretch', flexBasis: 'auto', flexGrow: 0, flexShrink: 0 }, cardHeader: { alignItems: 'flex-start', flexDirection: 'row', gap: 12, justifyContent: 'space-between', marginBottom: 16 }, cardHeaderText: { flex: 1, minWidth: 0 }, eyebrow: { color: '#43805D', fontSize: 11, fontWeight: '700', letterSpacing: 0.8, marginBottom: 4 }, title: { color: '#075A35', fontSize: 22, fontWeight: '700', lineHeight: 27 }, cardDescription: { color: '#62746A', fontSize: 13, lineHeight: 19, marginTop: 5 }, statusPill: { borderRadius: 99, paddingHorizontal: 10, paddingVertical: 5 }, entryPill: { backgroundColor: '#DCF3E4' }, exitPill: { backgroundColor: '#FCE7E2' }, statusPillText: { color: '#17663D', fontSize: 12, fontWeight: '700' }, exitPillText: { color: '#A53427' }, notice: { backgroundColor: '#F2F7F3', borderColor: '#D5E0D9', borderLeftColor: '#43805D', borderLeftWidth: 3, borderRadius: 7, marginBottom: 14, paddingHorizontal: 10, paddingVertical: 9 }, noticeText: { color: '#466154', fontSize: 12, lineHeight: 17 }, formSection: { gap: 12 }, exitFormSection: { alignSelf: 'stretch', flexGrow: 0, justifyContent: 'flex-start' }, stockField: { flexGrow: 0 }, fieldRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 12 }, fieldsColumn: { flexDirection: 'column' }, halfField: { flexBasis: 180, flexGrow: 1 }, fullField: { flexBasis: 'auto', width: '100%' }, cardFooter: { alignItems: 'center', borderTopColor: '#E2EAE5', borderTopWidth: 1, flexDirection: 'row', gap: 12, justifyContent: 'space-between', marginTop: 18, paddingTop: 14 }, footerHint: { color: '#62746A', flex: 1, fontSize: 12, lineHeight: 17 }, buttonRow: { alignSelf: 'flex-start' }, movementsCard: { marginTop: 14, padding: 16 }, movementsHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', marginBottom: 14 }, movementsTitle: { color: '#075A35', fontSize: 20, fontWeight: '700', lineHeight: 24 }, countPill: { backgroundColor: '#EAF3ED', borderRadius: 99, paddingHorizontal: 10, paddingVertical: 5 }, countPillText: { color: '#17663D', fontSize: 12, fontWeight: '700' }, table: { borderColor: '#D5E0D9', borderWidth: 1, overflow: 'hidden' }, tableScrollContent: { minWidth: '100%' }, tableContent: { minWidth: 860 }, row: { flexDirection: 'row', minHeight: 42 }, alternateRow: { backgroundColor: '#EEF6F1' }, tableHeader: { backgroundColor: '#14653B', minHeight: 34 }, cell: { borderRightColor: '#D5E0D9', borderRightWidth: 1, color: '#23362B', flex: 1, fontSize: 13, minWidth: 0, paddingHorizontal: 9, paddingVertical: 10 }, headerCell: { color: '#FFFFFF', fontWeight: '700', paddingVertical: 9 }, movementList: { gap: 10 }, movementItem: { backgroundColor: '#F6FAF7', borderColor: '#D5E0D9', borderRadius: 10, borderWidth: 1, gap: 9, padding: 13 }, movementDetail: { borderBottomColor: '#E1EAE4', borderBottomWidth: 1, flexDirection: 'row', gap: 12, justifyContent: 'space-between', paddingBottom: 8 }, movementLabel: { color: '#075A35', flex: 1, fontSize: 12, fontWeight: '700' }, movementValue: { color: '#23362B', flex: 2, fontSize: 13, textAlign: 'right' },
});
